...
namespace business
{
    class PrintDGV
    {
        ...
        private static int intUserLimit = 0;
        private const int LIMITACCESS = 18;
        ...
        public static void Print_DataGridView(DataGridView dgv1, string strTitle, bool bPrv, int iUserLimit)
        {
            //权限控制
            intUserLimit = iUserLimit;
            if (intUserLimit < LIMITACCESS)
            {
                MessageBox.Show("你的权限不足");
                return;
